...
- `sync/juku_top_checkpoint_resume_probe.py` — fast checkpoint-resume probe;
  loads the same checkpoint into `juku_top`, seeds the vm80a core at a clean M1
  fetch boundary, and proves the resumed top-level CPU path reaches the pinned
