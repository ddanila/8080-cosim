...
Current scope: 108 mapped instances and 279 compared nets. Placement-only
...
raw disk geometry, the bounded WD1793 boot subset plus Type-II multi-record and
Read Address, raster/serializer behavior,
