...
- `sync/check.sh` currently compares 101 mapped instances and 257 nets with no
  KiCad/HDL mismatch.
...
- The main board is **not released for fabrication**. Validated physical D2
  ...
  8 and 11 remain explicit boundaries. In total, 228 modeled nets retain source-risk annotations requiring
