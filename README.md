...
compact loader switched to 19,200 baud. V15 is no longer a supported host path;
the GIF remains as historical evidence and is not regenerated by the current
demo runner.
