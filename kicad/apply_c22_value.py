#!/usr/bin/env python3
"""Transplant the generated C22 value-bearing footprint into the source PCB."""
...
def main() -> int:
    if len(sys.argv) != 3:
        raise SystemExit("usage: apply_c22_value.py TARGET.kicad_pcb DONOR.kicad_pcb")
    ...
    print(f"patched {target_path}: updated C22 value")
    return 0
