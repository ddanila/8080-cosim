#!/usr/bin/env python3
"""Transplant generated R92/R99 value-bearing footprints into the source PCB."""
...
def main() -> int:
    if len(sys.argv) != 3:
        raise SystemExit("usage: apply_kp12_resistor_values.py TARGET.kicad_pcb DONOR.kicad_pcb")
