...
FUNCTIONAL_SUBSTITUTE = {
    ...
    "VG93_FDC": "Western Digital FD1793B-01 plastic DIP; bench-verify clocks, strobes, and drive interface",
    "IO_DEC138": "74LS138 / 74HCT138 decoder",
    "RASCAS_DEC": "74S138/74F138-class fast decoder; verify timing",
    "IE7_CTR": "SN74LS193-compatible up/down counter; standard behavior guarded, verify board wiring",
    ...
    "KP14_MUX": "SN74LS/S258-class inverting quad 2:1 mux with active-low enable",
    ...
    "IE10_CTR": "SN74LS161A-compatible synchronous binary counter; D103 /13 behavior guarded",
...
TYPE_NOTES = {
    ...
    "RU5": "D84-D91 are populated for the 64 KB .158/.009 target; D60-D83 are empty expansion sockets. The guarded MK4564-12 static contract is package/electrically eligible only with E4 2-3/+5 V; receipt and board timing tests remain.",
    "VG93_FDC": "The guarded FD1793B-01 static contract matches the D93 package, rails, pins, and 1 MHz mode; support-device closure and received-part board testing remain.",
