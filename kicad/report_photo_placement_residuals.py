...
pattern=re.compile(r"projected \(([-0-9.]+),([-0-9.]+)\)"); groups=defaultdict(list)
...
lines=["# Photo placement residual audit","","Status: **CANDIDATE GEOMETRY / REVIEW REQUIRED**","",
"Only uniquely snapped solder-hole candidates are grouped. No row is electrical evidence and no placement is changed automatically.","",
