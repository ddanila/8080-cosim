...
1. **Complete FDC-era functional wiring.** D93's drive-interface pins plus
   ...
   LVS instance map. This raises the proved scope to 115 instances/298 nets and
...
5. **Disposition all remaining source-risk nets and omitted endpoints.**
   45 source-risk nets and 3 official FDC devices with untraced functional
