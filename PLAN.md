...
and all electrical blocker categories remain zero. One hundred sixty-eight
...
X4_HLOAD_N, X4_WR_GATE_N, D13_4_D105_2, XTAL16M, and D103_LD, each independently
reduce the uncapped graph, reaching 509 opens; all one hundred sixty-eight are
promoted. The final one hundred sixty-four are selected by
