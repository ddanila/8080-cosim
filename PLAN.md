...
2. **Continue routing convergence on the refresh candidate.** The
   ...
   refinement to 0.125 mm; 36 unconnected items on 34 nets remain as of
   2026-07-14. Next: keep tightening the search parameters where sweeps still
   accept routes, then partition or hand-route the residual nets, and clear
