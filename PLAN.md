...
MEMR, BA9, BA1, D3_O4_D6_A6, E3_COM, INTR, RES_RC, D13_4_D105_2, and D105_10_H, each independently reduce the uncapped
graph, reaching 16 opens; all six hundred sixty-one are promoted. The final
six hundred fifty-seven are
...
`E3_COM`, `INTR`, `RES_RC`, `D13_4_D105_2`, and `D105_10_H` attempts pass the same complete KiCad DRC guard.
