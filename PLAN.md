...
| `JRV-HW` | Jukuravi harness | PHYSICAL T31/T32 VALIDATED; D1 FAULT REPAIRED; D55 OPEN | substitute D55 and rerun its guarded PIT diagnostics; keep optional Nano reset/liveness wiring measurement-gated | `spinoffs/jukuravi/T31-PHYSICAL.md`; `spinoffs/jukuravi/T32-PHYSICAL.md`; `docs/cs00015-service-record.md` |
...
- [x] Generated C/HDL FDC differential matches 12 deterministic command/event
  scenarios across 608 state transitions without claiming physical timing.
