...
| Connectivity | `sync/check.sh` reports 101 mapped instances and 255 matched nets; physical D2/D6 PROM tables, the measured D2/D30/D105/D13 READY/DBIN handoff, and D41 timing rails 8/17 are source-modeled and LVS-visible | Routed-snapshot parity, omitted remote endpoints, behavioral correctness, analog waveforms, and historical correctness of assumed nets |
...
4. **Disposition all remaining source-risk nets and omitted endpoints.** The
   current generated evidence lists 212 source-risk nets and 9 official FDC
