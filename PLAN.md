...
and all electrical blocker categories remain zero. Two hundred ten
...
OSC_FB, FDC_RE_N, D40_CTRL_PULL, MA7, and VT2_BASE, each independently reduce
the uncapped graph, reaching 467 opens; all two hundred ten are promoted. The
final two hundred six are selected by
