...
and all electrical blocker categories remain zero. Nineteen bounded
nonzero-gap proposals, including P5V, STSTB, GND, W10_QA_SEL, D40Q1_D39,
LATCH_B, and REV, each independently reduce the uncapped graph, reaching 658
opens; all nineteen are promoted. The final fifteen are selected by a
