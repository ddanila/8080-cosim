...
| `JRV-HW` | Jukuravi harness | CS00015 EKTA4401/JUKURAVI SERVICE ROM FITTED IN HOME LAB; CS00014 STOCK-ROM EXHIBIT; CS00000 USART FAULT SUSPECTED; OLD D55 PREDICATE INVALIDATED | preserve CS00014's exhibition state; use CS00015 as the working reference; isolate CS00000 serial failure from clock/status through connector and level conversion before any D11 diagnosis | `docs/machine-deployment-status.md`; `docs/cs00015-service-record.md`; `docs/serial-handoff.md` |
