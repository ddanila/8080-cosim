...
1. **Preserve routing convergence until netlist freeze.** The deterministic
   ...
   copper-island splits are modeled. Four `А:19`/`А:20` endpoints are now registered in
