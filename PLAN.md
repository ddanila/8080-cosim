...
and all electrical blocker categories remain zero. One hundred forty-one
...
V3_RC, DB0, RAIL_H, P12V, MA3, BA13, D53_Y1_R50, X4_TR00_N, and CAS_PRE, each
independently reduce the uncapped graph, reaching 536 opens; all one hundred
forty-one are promoted. The final one hundred thirty-seven are selected by
