...
ROM_CS_4000, each independently reduce the uncapped graph, reaching 168 opens;
all five hundred nine are promoted. The final five hundred five are
selected by a transactional orchestrator that rejects
capped-only marker advances and continues searching.
Its conservative multilayer search is exhausted through 100 mm.
