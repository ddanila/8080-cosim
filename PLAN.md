...
MEMR, BA9, BA1, D3_O4_D6_A6, E3_COM, INTR, RES_RC, D13_4_D105_2, D105_10_H, CS_D54, and FDC_DSEL_IN, each independently reduce the uncapped
graph, reaching 14 opens; all six hundred sixty-three are promoted. The final
six hundred fifty-nine are
...
`E3_COM`, `INTR`, `RES_RC`, `D13_4_D105_2`, `D105_10_H`, `CS_D54`, and `FDC_DSEL_IN` attempts pass the same complete KiCad DRC guard.
