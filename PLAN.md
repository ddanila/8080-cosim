...
D99_C1_TIMING, RESET, OSC, DBIN, and TIMING_TAG17, each independently reduce the
uncapped graph, reaching 374 opens; all three hundred three are promoted. The
final two hundred ninety-nine are selected by
