...
and all electrical blocker categories remain zero. One hundred thirty-three
...
V3_RC, DB0, RAIL_H, P12V, MA3, BA13, D53_Y1_R50, and X4_TR00_N, each
independently reduce the uncapped graph, reaching 544 opens; all one hundred
thirty-three are promoted. The final one hundred twenty-nine are selected by
