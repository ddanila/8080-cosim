...
WREQ_N, PIT_BAUD, ROE, STSTB_D38, CTR_LD, RAM_OUT_EN, MA2, MA1, and S3_5, each
independently reduce the uncapped graph, reaching 26 opens; all six hundred
fifty-one are promoted. The final six hundred forty-seven are
...
its `MA2`, `MA1`, and `S3_5` attempts pass the same complete KiCad DRC guard.
