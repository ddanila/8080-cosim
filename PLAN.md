...
and all electrical blocker categories remain zero. Two hundred sixty-seven
...
FDC_EARLY_SEL, each independently reduce the uncapped graph, reaching 410 opens;
all two hundred sixty-seven are promoted. The final two hundred sixty-three are selected by
