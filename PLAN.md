...
PST_CLK, DB3, SER_RXD, and S_DTP, each independently reduce the uncapped graph,
reaching 286 opens; all three hundred ninety-one are promoted. The final three
