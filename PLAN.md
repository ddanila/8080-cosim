...
Source-model state feeding this work: the authoritative board JSON defines all 2295/2295
...
coverage report proves 2295/2295 endpoint-name matches on each artifact, and
