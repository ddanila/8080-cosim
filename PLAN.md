...
WREQ_N, PIT_BAUD, ROE, STSTB_D38, CTR_LD, RAM_OUT_EN, and MA2, each
independently reduce the uncapped graph, reaching 28 opens; all six hundred
forty-nine are promoted. The final six hundred forty-five are
...
its first `MA2` attempt passes the same complete KiCad DRC guard.
