...
| Connectivity | `sync/check.sh` reports 101 mapped instances and 260 matched nets; physical D2/D6 PROM tables, the measured D2/D30/D105/D13 READY/DBIN handoff, D41 timing rails 8/17, the X1.107C `-WREQ` endpoint, the D26.PC7-to-D35 `POF` path, D11 RXRDY/TXRDY into D10 IR2/IR3, and D7.3 into D29.6 `-AMWC` are source-modeled and LVS-visible | Routed-snapshot parity, omitted remote endpoints, behavioral correctness, analog waveforms, and historical correctness of assumed nets |
