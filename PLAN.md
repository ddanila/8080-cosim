...
and all electrical blocker categories remain zero. Eighty-six bounded
...
D99_RC2_TIMING, FDC_CLK, FRAME_INT, D39Y, D102_C2_C20, D92_NOACC, and
D100_CONTROL_SHEET1_BOUNDARY, each independently reduce the uncapped graph,
reaching 591 opens; all eighty-six are promoted. The final eighty-two are
