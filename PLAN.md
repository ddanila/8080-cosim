...
ROM_CS_4000, each independently reduce the uncapped graph, reaching 170 opens;
all five hundred seven are promoted. The final five hundred three are
selected by a transactional orchestrator that rejects
capped-only marker advances and continues searching.
Its conservative multilayer search is exhausted through 90 mm.
