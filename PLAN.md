...
1. **Preserve routing convergence until netlist freeze.** The deterministic
   ...
   copper-island splits are modeled. Six `А:11`/`А:19`/`А:20` endpoints are now registered in
