...
AVDC, KBD_K0, VID_CPU_SEL, VA11, and FDC_PRECOMP_WRDATA, each independently
reduce the uncapped graph, reaching 362 opens; all three hundred fifteen are
promoted. The final three hundred eleven are selected by
