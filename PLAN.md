...
FDC_WDATA_DELAY_IN, VERT_RTR, VA0, and PRECOMP_TAP_3, each independently reduce
the uncapped graph, reaching 220 opens; all four hundred fifty-seven are
promoted. The final four hundred fifty-three are
