...
and all electrical blocker categories remain zero. One hundred twenty-five
...
V3_RC, DB0, RAIL_H, and P12V, each independently reduce the uncapped graph,
reaching 552 opens; all one hundred twenty-five are promoted. The final one
hundred twenty-one are selected by a transactional orchestrator that rejects
