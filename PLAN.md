...
MEMR, BA9, BA1, D3_O4_D6_A6, E3_COM, INTR, RES_RC, D13_4_D105_2, D105_10_H, CS_D54, FDC_DSEL_IN, and FDC_MOTOR_EN, each independently reduce the uncapped
graph, reaching 13 opens; all six hundred sixty-four are promoted. The final
six hundred sixty are
...
`E3_COM`, `INTR`, `RES_RC`, `D13_4_D105_2`, `D105_10_H`, `CS_D54`, `FDC_DSEL_IN`, and `FDC_MOTOR_EN` attempts pass the same complete KiCad DRC guard.
