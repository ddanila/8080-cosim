...
MEMR, and BA9, each independently reduce the uncapped graph, reaching 23 opens;
all six hundred fifty-four are promoted. The final six hundred fifty are
...
its `MA2`, `MA1`, `S3_5`, `DB7`, `MEMR`, and `BA9` attempts pass the same
complete KiCad DRC guard.
