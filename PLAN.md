...
2. **Preserve routing convergence until netlist freeze.** The deterministic
   ...
   fitted too, leaving four PCB coordinates/island assignments pending. A14B's
   current D40-local projection is only 0.784 mm from independently placed
   D41.1, so W14 remains held pending cross-registration or direct measurement. Both
