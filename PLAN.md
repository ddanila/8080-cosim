...
and all electrical blocker categories remain zero. Two hundred seventy-three
...
FDC_EARLY_SEL, DC3, D99_RC2_TIMING, and PRECOMP_TAP_1, each independently reduce
the uncapped graph, reaching 404 opens; all two hundred seventy-three are
promoted. The final two hundred sixty-nine are selected by
