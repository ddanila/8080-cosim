...
a current-lineage routing baseline. Same-name/additive migration imports 8,397
...
MEMR, BA9, BA1, D3_O4_D6_A6, E3_COM, INTR, RES_RC, D13_4_D105_2, D105_10_H, CS_D54, FDC_DSEL_IN, FDC_MOTOR_EN, and FDC_SIDE_SEL, each independently reduce the uncapped
graph, reaching 12 opens; all six hundred sixty-five are promoted. The final
six hundred sixty-one are
...
`E3_COM`, `INTR`, `RES_RC`, `D13_4_D105_2`, `D105_10_H`, `CS_D54`, `FDC_DSEL_IN`, `FDC_MOTOR_EN`, and `FDC_SIDE_SEL` attempts pass the same complete KiCad DRC guard.
