...
AVDC, KBD_K0, VID_CPU_SEL, and VA11, each independently reduce the uncapped
graph, reaching 364 opens; all three hundred thirteen are promoted. The final
three hundred nine are selected by
