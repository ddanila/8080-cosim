...
`else
    tri0 fdc_clk_1m;
`endif
    // Corrected two-sided photo registration and continuous copper prove
    // D106 К555ИЕ7 Q3/pin7 -> D93 CLK/pin24. D106's upstream count/control
    // network remains a boundary, so the clock rail is released here.
