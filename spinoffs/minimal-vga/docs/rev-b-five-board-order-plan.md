...
This supersedes the currently recorded fabrication hashes; R5.J2/J3 and the held
R5.R1 record must be refreshed after human PNG review. See
...
| **R5.J2 — REFRESH REQUIRED** | Regenerate all five fabrication ZIPs in one release run. Emit a manifest with source revision, tool versions, board dimensions/layers, file list and SHA-256 per archive. | R5.P1, R5.S3, R5.V6, R5.J1, assembly-silk review | The former revision `90012621` package is superseded by the complete ref+value assembly legend. After human acceptance, `export_fab.sh` must emit and verify a new exact five-archive set. |
| **R5.J3 — REFRESH REQUIRED** | Perform an independent pre-upload review and obtain a fresh live JLCPCB quote. Check every Gerber/drill rendering separately; reconcile the five designs with BOM quantities and programmed-device count. | R5.J2 | Repeat the 42 individual layer/drill plus 10 composite review against the new hashes. The same-day no-upload quote remains context, not package authorization. |
...
## R5.J2 release-candidate identity
...
`90012621b45a923e8315c0e5ca6a38092b518885`; the ZIP files themselves remain
...
|---|---:|---:|---:|---|
| CPU | 2 | 9 | 26,975 | `2335e88fc54e5d6efa7f8ba48d1bcb814b9d7e9960d581d4506c95aae361389d` |
| Memory | 2 | 9 | 33,740 | `a2c903d130d87b9ea970fe8d9c0408d3751c181eb51a3406a712042874bff7b2` |
| I/O | 2 | 9 | 48,709 | `fb29708fab4d1070101ca26f0a053b4d059fbb8956847bb6382f97478417bc19` |
| Backplane | 2 | 9 | 64,047 | `1a642c0b7d5ed282da03ee263d7a66ee00d6ee93394e456dc4799f501a5ea590` |
| Video | 4 | 11 | 437,926 | `46e13e63c3b4df4eb05f70c38dd2d810860d6503b36db85feabcace324b5f4ab` |
...
- **DONE 2026-08-28:** All five reviewed routed board sources are present in a clean
      checkout and feed the one-command fabrication release.
- **DONE 2026-08-28:** All five pass full net/pin checks, total DRC 0/0 and
      mechanical mating.
- **DONE 2026-08-28:** The five-card simulation boots EKTA byte-identically and passes VGA timing,
