...
| D1.38 | What supply and distribution corner releases the VGA-populated machine? | **Mean Well GST25A05-P1J, individually receipt-tested at 1.351 A for >=4.90 V average and <=80 mVpp; Video in slot 5, slot 4 empty.** Route VCC/GND buses at 0.80 mm and raw barrel-to-fuse copper at 2.00 mm on 1 oz. | R5.J2 release-source actual-copper solve including maximum initial fuse/jack/contact losses yields 4.628 V minimum trough, 128 mV above the 4.50 V floor. The datasheet-only -5% adapter corner yields 4.478 V, so receipt testing is a real gate, not optional prose. |
