...
The three-voice speaker demo originally shared this diagnostic firmware
directory because Jukuravi delivered its first physical run.  The independent
CP/M music engine, generated songs, importers, renderer, regressions, and
physical evidence now live in [`../../jukupoly/`](../../jukupoly/README.md).
This directory remains specific to Jukuravi diagnostics and recovery firmware.
