...
def main() -> int:
    ...
    add("Still open:")
    add("")
    add("- The real asymmetry is **CAS-gated versus unwaited**, not fetch versus")
    add("  read, and not upper versus lower. A fault in the CAS-gated release path")
    add("  fits every observation.")
