...
def main() -> int:
    ...
    control_checks = [
        ...
        (
            "`X2_IRQ0` / `X2_PB7`",
            "source-closed D10 IR0/IR1 external inputs (not assigned to FDC)",
            [("X2_IRQ0", "D10", "18"), ("X2_PB7", "D10", "19")],
            False,
            "exact .009 sheet 1; retired as inferred FDC destinations",
        ),
    ]
    ...
    lines = [
        ...
        table_row(["read-clock toggle", "74LS74", "D96 КМ555ТМ2", "section 1 source-closed; section 2 local conditioner closed, remote Q/CLK open"]),
        "",
