    ...
    return [
        ...
        },
        {
            ...
            "evidence": (
                ...
                "that execution is mode-1 RAM and only sees zero-byte writes. "
                ...
                + (
                    ...
                    "then jumps to `0x0100`. The loaded image changes the "
                    "`0x0100` stack pointer to `0xFFFE`, leaves the body exact, "
                    "and narrows the remaining cartridge work to the post-`0x0100` "
                    "low workspace/control handoff. "
