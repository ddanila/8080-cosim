...
SOURCE_ROWS = [
    ...
    (
        ...
        "Additional museum `tarkvara/*.JUK` classroom/game/user disks and "
        "`kirjandus/` manuals are not exhaustively classified. The Baltijets "
        "programming disk files referenced by doc 007 remain missing.",
    ),
    (
