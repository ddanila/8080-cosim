...
def main() -> int:
    ...
    lines = [
        ...
        "- The decisive remaining hardware check is a powered-off map with D6 removed:",
        "  verify D6.9-D13.1, D13.2-D37.4, and D37.6-D58.9 independently, and",
        "  find the target-board driver for D92.5/R12.2. Then record live D6.9, D13.2, D37.6, D58.9, and D58.11 during",
