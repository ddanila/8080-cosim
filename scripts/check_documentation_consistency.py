...
def main() -> int:
    ...
    if not live_prune_path.exists():
        ...
        if (
            ...
            or live_prune.get("output_board_size") != 9448064
            or (identity.get("footprints"), identity.get("pads")) != (321, 2434)
            or initial.get("uncapped_unconnected") != 883
            or pruned.get("uncapped_unconnected") != 677
            or final.get("uncapped_unconnected") != 39
            or final.get("routed_nets") != 393
            ...
            or probe.get("accepted_routes_by_uncapped_guard") != 638
            or probe.get("uncapped_unconnected_before") - probe.get("uncapped_unconnected_after") != 638
            or probe.get("rule_accurate_multilayer_clearance_mm") != 0.21
            or probe.get("rule_accurate_multilayer_grid_step_mm") != 0.25
            or probe.get("rule_accurate_multilayer_exhausted_through_mm") != 130
