...
def main() -> int:
    ...
    if not live_prune_path.exists():
        ...
        if (
            ...
            or live_prune.get("output_board_size") != 7588376
            or (identity.get("footprints"), identity.get("pads")) != (321, 2434)
            or initial.get("uncapped_unconnected") != 883
            or pruned.get("uncapped_unconnected") != 677
            or final.get("uncapped_unconnected") != 413
            or final.get("routed_nets") != 273
            ...
            or probe.get("accepted_routes_by_uncapped_guard") != 264
            or probe.get("uncapped_unconnected_before") - probe.get("uncapped_unconnected_after") != 264
