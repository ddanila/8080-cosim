...
def main() -> int:
    ...
    priority_rows = [
        ...
        (
            ...
            "first find the source, pull device, or obscured branch on the measured D6.15-D105.1 input-only boundary; D6.1<-D3.4<-/PC1 and D6.2<-D3.6<-/PC0 are now closed. Chip-removed continuity closes D6.12-D8.15, proves D6.11/D6.12 separate, and routes D6.11 to D2.15/-WREQ; find the actual target-board driver for the older-sheet D92.5/R12.2 RAM branch. Confirm D13.12-D6.13/.14 and recheck the surprising D13.12-D16.13 report with D16 removed. D6.9-D13.1 and D13.2-D37.4 are owner-confirmed; verify only the remaining D37.6-D58.9 segment where accessible. During the known B37A RAM read scope D6.9, D13.2, D37.6, D58.9, and D58.11. All eight raw A7..A5 rows leave pin9 high at B37A. Still close C99 far plate, the upstream D7.5/D29.3 -INHIB source, and remaining D36 timing feeds",
