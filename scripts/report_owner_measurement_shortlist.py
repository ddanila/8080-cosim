...
def main() -> int:
    ...
    priority_rows = [
        ...
        (
            ...
            "`docs/fdc-hardware-handoff.md`; `docs/d99-reconstruction-constraints.md`; `docs/d101-reconstruction-constraints.md`; `ref/schematics/fdc-unused-pin-dispositions.md`; `ref/schematics/fdc-clock-mux-map.md`; `ref/schematics/fdc-recovery-counter-map.md`; `ref/schematics/fdc-read-clock-toggle-map.md`; `ref/schematics/fdc-write-precomp-map.md`; `PLAN.md` P0 connectivity gate",
