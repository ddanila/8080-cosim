...
def main() -> int:
    ...
    priority_rows = [
        ...
        (
            ...
            "one D106.7/D96.5 comparison now separates the two historically plausible read-clock designs, while the mux probes test the package family that the WD-only comparison left unexplained",
        ),
        (
            "P1",
