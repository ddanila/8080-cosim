...
def main() -> int:
    ...
    priority_rows = [
        ...
        (
            ...
            "first find the source, pull device, or obscured branch on the measured D6.15-D105.1 input-only boundary; D6.1<-D3.4<-/PC1 and D6.2<-D3.6<-/PC0 are now closed. With power removed and D6 removed, verify D6.9-D13.1, D13.2-D37.4, and D37.6-D58.9 independently where accessible; then resistance-map D6.11 and D6.12 separately to D13.12, D8.15, D92.5, R11.2, and R12.2, recording positive and negative readings. During the known B37A RAM read scope D6.9, D13.2, D37.6, D58.9, and D58.11. All eight raw A7..A5 rows leave pin9 high at B37A; do not assume a D8 feedback branch merely because D8 changes EF-to-FF. Still close the V1/V2 feed for fidelity, plus C99 far plate, the upstream D7.5/D29.3 -INHIB source, and remaining D36 timing feeds",
