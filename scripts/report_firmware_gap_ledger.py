...
def main() -> int:
    ...
    rows = [
        ...
        [
            ...
            d94_cell,
            "`docs/d94-reconstruction-constraints.md`",
            "programming-disk comparison plus the equation-targeted D0 hidden-branch probe, pull-up resistor identities, and the guarded D29.4/IORD recheck; D4-D7 and D104.10 are owner/drawing-closed NC",
        ],
        [
            "D15",
            "M2764/2764",
