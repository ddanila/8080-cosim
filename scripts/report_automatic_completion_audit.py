...
GROUPS = {
    ...
    "firmware": Group(
        "Adopted PROM/EPROM set",
        "Cross-machine small-PROM reads and the independent archival D15/D16 pair are adopted",
        "none; later reads are optional preservation evidence",
        (
            Evidence("docs/firmware-gap-ledger.md", "ADOPTED FIRMWARE SET VERIFIED", "adopted content set guarded"),
