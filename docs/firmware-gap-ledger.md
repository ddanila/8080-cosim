...
| D94 | К155РЕ3 | `ДГШ5.106.092` | FDC control/decode PROM | `ref/physical-proms/validated/d94_092.raw.bin` (32 bytes, SHA256 `bcf942a87ee70adb1a16cebb7f018cf8f491ea2a74db0b0a5dd7d5c8db8a29e0`) | `docs/d94-reconstruction-constraints.md` | programming-disk comparison plus D4-D7 destinations, D104.10 receiver-output continuity, pull-up resistor identities, and the guarded D29.4/IORD recheck |
