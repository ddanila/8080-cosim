...
| Check | Result |
| --- | --- |
| Required local media/ROM/source files exist | PASS |
| `media/disks/J3KUTIL4.JUK` is vendored with expected 819200-byte hash | PASS |
| Disk/system manifests include required vendored binaries | PASS |
| Museum `JUKUROMS.ZIP` inspected as byte-identical to `roms/` payloads | PASS |

## Inspected Small Archives

| Archive | SHA256 | Contents / disposition |
| --- | --- | --- |
| `JUKUROMS.ZIP` | `e9b8da139a5766ca6a16c100989d8a6c52d2adb882efe6bb3cf79ba8034fc731` | nine canonical ROM files; every payload hash matched `roms/` |
| `MANUALID.ZIP` | `430d9e865fbe3a3c619ca6e7154c443c2a93f738cf9c1b2652173bf4b9992309` | `DBASE.DOK`, `GTR.DOK`, `GTRLISA.DOK`, `JCM.DOK`; optional user docs |
| `INDY.ZIP` | `e01145360b8e6a033f1da3311bd8cb42ec993adb6c365b8c0ebe53a73a3ea891` | game package; optional user software |

## Arti `tarkvara/` Listing
...
## Elektroonikamuuseum `tarkvara/` Listing
