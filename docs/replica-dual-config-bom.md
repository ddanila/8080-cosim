...
- Board component positions: 335
- Populate for current functional .009 build: 271
...
| circuit-review | C_KM | КМ ceramic capacitor | modern ceramic capacitor with matching value/voltage/lead spacing | 9 | 9 | 0 | C9, C10, C11, C12, C15, C16, C19, C34, C94 | - |
...
| mechanical-review | PAR_CONN | СНП59-30-23-В / parallel connector | select exact substitute after circuit review | 1 | 1 | 0 | X2 | - |
...
| mechanical-review | SERIAL_CONN | РГ1Н-1-4 12-contact serial socket (cable mate РШ2Н-1-23/-24) | select exact substitute after circuit review | 1 | 1 | 0 | X3 | - |
...
| source-now | D_DIODE КД521В | Soviet diode/zener per value КД521В | modern diode/zener matching value and power | 2 | 2 | 0 | VD1, VD4 | - |
...
| source-now | IR16 | К555ИР16 | SN74LS295B-class falling-edge shift register with active-high OC | 3 | 3 | 0 | D41, D42, D43 | - |
...
| source-now | KP14_MUX | КР531КП14 | SN74LS/S258-class inverting quad 2:1 mux with active-low enable | 4 | 4 | 0 | D48, D49, D50, D51 | - |
| source-now | KP14_MUX | К555КП14 | SN74LS/S258-class inverting quad 2:1 mux with active-low enable | 1 | 1 | 0 | D52 | - |
...
| source-now | RU5 | К565РУ5Г | Mostek MK4564-12 dual-in-line option; E4 2-3/+5 V required; bench-test received parts | 8 | 8 | 0 | D84, D85, D86, D87, D88, D89, D90, D91 | D84-D91 are populated for the 64 KB .158/.009 target; D60-D83 are empty expansion sockets. The guarded MK4564-12 static contract is package/electrically eligible only with E4 2-3/+5 V; receipt and board timing tests remain. |
...
| source-now | R_AXIAL 10к | axial resistor 10к | modern axial resistor, matching value and power rating | 3 | 3 | 0 | R78, R93, R94 | - |
...
| source-now | R_AXIAL 220 | axial resistor 220 | modern axial resistor, matching value and power rating | 1 | 1 | 0 | RUNK1 | - |
| source-now | R_AXIAL 2к | axial resistor 2к | modern axial resistor, matching value and power rating | 7 | 7 | 0 | R1, R5, R6, R8, R62, R90, R95 | - |
...
| source-now | VG93_FDC | КР1818ВГ93 | Western Digital FD1793B-01 plastic DIP; bench-verify clocks, strobes, and drive interface | 1 | 1 | 0 | D93 | The guarded FD1793B-01 static contract matches the D93 package, rails, pins, and 1 MHz mode; support-device closure and received-part board testing remain. |
