...
| mechanical-review | SERIAL_CONN | РШ2Н-1/РГ1Н-1-family serial connector, exact variant pending owner check | select exact substitute after circuit review | 1 | 1 | 0 | X3 | - |
