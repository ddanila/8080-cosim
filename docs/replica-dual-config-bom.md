...
- Board component positions: 317
- Populate for current functional .009 build: 287
...
| circuit-review | C_KM | КМ ceramic capacitor | modern ceramic capacitor with matching value/voltage/lead spacing | 14 | 14 | 0 | C7, C8, C9, C10, C11, C13, C14, C15, C16, C19, C20, C22, C34, C99 | - |
...
| circuit-review | R_AXIAL | axial resistor | modern axial resistor, matching value and power rating | 49 | 49 | 0 | R11, R12, R13, R14, R17, R40, R41, R42, R43, R44, R45, R47, R48, R49, R50, R51, R52, R53, ... (+31) | - |
