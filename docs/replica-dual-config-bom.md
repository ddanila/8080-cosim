...
| circuit-review | L_RADIAL | radial inductor/choke | modern radial choke/inductor after value confirmation | 1 | 1 | 0 | L1 | - |
...
| program/dump | RE3_PROM_113 | К155РЕ3 | 74188/82S23-class 32x8 bipolar PROM, programmed | 1 | 1 | 0 | D94 | FDC-revision timing/window PROM contents remain dump/reconstruction-gated. |
