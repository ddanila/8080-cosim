...
PRECOMP_CASCADE_2, V3_RC, DB0, RAIL_H, P12V, MA3, BA13, D53_Y1_R50, and
X4_TR00_N then each pass an independent uncapped check, reducing the exact
count to 544; those routes are promoted. The last one hundred twenty-nine are
