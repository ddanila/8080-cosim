...
AVDC, KBD_K0, VID_CPU_SEL, and VA11 then each pass an independent uncapped check,
reducing the exact count to 364; those routes are promoted. The last three
hundred nine are selected transactionally by
