...
A12, A15, SEP_D106_Q3, IORD, ROM_CS_A000, S_DSR, FDC_CS_N, and DB2 then each
pass an independent uncapped check, reducing the exact count to 437; those
routes are promoted. The last two hundred thirty-six are
