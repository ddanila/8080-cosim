...
X2_PB5, X2_PB4, X2_PB3, FDC_SEPARATOR_CLOCK, MA6, WR, and S_CTS then each pass
an independent uncapped check, reducing the exact count to 413; those routes
are promoted. The last two hundred sixty are
