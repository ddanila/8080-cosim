...
D33_6_D36, W_RAIL16, S_SOUT, VA1, X2_IRQ0, and SER_CTS_N then each pass an
independent uncapped check, reducing the exact count to 239; those routes are
promoted. The last four hundred thirty-four are
