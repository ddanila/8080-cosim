...
FDC_TR00_STATUS, ROM_CS_6000, INHIB_STATUS_BOUNDARY, and VA13 then each pass an
independent uncapped check, reducing the exact count to 178; those routes are
promoted. The last four hundred ninety-five are
