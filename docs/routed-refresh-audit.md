...
D105_MEMW_INV, BA1, SER_DTR, ROM_CS_EXP17, and D53_Y0_R49 then each pass an
independent uncapped check, reducing the exact count to 392; those routes are
promoted. The last two hundred eighty-one are
