...
D99_C1_TIMING, RESET, OSC, DBIN, and TIMING_TAG17 then each pass an independent
uncapped check, reducing the exact count to 374; those routes are promoted. The
last two hundred ninety-nine are
