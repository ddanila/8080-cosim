...
VA5, FDC_RCLK, BA5, DB3, and PRECOMP_TAP_2 then each pass an independent
uncapped check, reducing the exact count to 97; those routes are promoted. The
last five hundred seventy-six are
