...
modeled. The source PCB now splits A:8, A:10, A:11, and A:19 into surface-landing
pairs joined by explicit assembly wires, so this checkpoint lacks those eight
pads and keeps the old STSTB, W10_QA_SEL, MEMR, and MEMW copper substitutions. The artifact remains useful convergence
...
2,383 of its pad identities, but current source has 2,391 pads after adding
W8.1/W8.2, W10.1/W10.2, W11.1/W11.2, and W19.1/W19.2. Among the common identities it finds 45 changed pad-net assignments and 138 pads
