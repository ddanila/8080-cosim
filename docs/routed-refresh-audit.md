...
W10_QA_SEL_D50, BA0, and VA8 then each pass an independent uncapped check,
reducing the exact count to 429; those routes are promoted. The last two
hundred forty-four are
