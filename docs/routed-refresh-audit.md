...
W10_QA_SEL_D50, BA0, VA8, X4_STEP_N, ROM_SEL, D53_Y2_R51, X2_PB7, X2_PB6, and
X2_PB5 then each pass an independent uncapped check, reducing the exact count
to 421; those routes are promoted. The last two hundred fifty-two are
