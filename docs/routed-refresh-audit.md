...
LOAD_PRE, FDC_WG_TO_D100, LATCH_A, and FDC_TG43_TO_D100 then each pass an
independent uncapped check, reducing the exact count to 228; those routes are
promoted. The last four hundred forty-five are
