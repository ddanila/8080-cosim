...
DB0, DB4, DB1, X2_PC1, and LATCH_B then each pass an independent uncapped check,
reducing the exact count to 109; those routes are promoted. The last five
hundred sixty-four are
