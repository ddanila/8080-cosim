...
RAM_OUT_EN, MA2, and MA1 then each pass an independent uncapped check, reducing
the exact count to 27; those routes are promoted. The last six hundred forty-six are
