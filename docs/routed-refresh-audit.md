...
SOUND_CLAMP, D94_D1_D99_A2N, RAIL14, SND_BASE, and D30B_D_PRE_N then each pass
an independent uncapped check, reducing the exact count to 330; those routes are
promoted. The last three hundred forty-three are
