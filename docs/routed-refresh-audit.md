...
PST_CLK then each pass an independent uncapped check, reducing the exact count
to 300; those routes are promoted. The last three hundred seventy-three are
