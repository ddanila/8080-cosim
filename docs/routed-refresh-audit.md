...
BA15, D94_A4_D101_Q0, BA13, CS_D11, CS_D27, IOWC_N, AMWC_N, MEMR, and BA12 then
each pass an independent uncapped check, reducing the exact count to 65; those
routes are promoted. The last six hundred eight are
