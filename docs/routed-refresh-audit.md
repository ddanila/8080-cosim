...
electrical blockers. Eighty bounded proposals across P5V, STSTB, GND,
...
D97_RC1_C16, D99_RC2_TIMING, FDC_CLK, FRAME_INT, D39Y, and D102_C2_C20 then
each pass an independent uncapped check, reducing the exact count to 597;
those routes are promoted. The last seventy-six are selected transactionally
