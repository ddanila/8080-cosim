...
S_OC, BA11, BA12, BA14, X4_INDEX_N, DB1, ROE, CLKG_D33, X3_HARNESS_1, and PHI2
then each pass an independent uncapped check, reducing the exact count to 481;
those routes are promoted. The last one hundred ninety-two are
