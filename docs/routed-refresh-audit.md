...
D33_6_D36, W_RAIL16, S_SOUT, VA1, X2_IRQ0, SER_CTS_N, DB6, and DB7 then each
pass an independent uncapped check, reducing the exact count to 236; those
routes are promoted. The last four hundred thirty-seven are
