...
D93_TEST_WF_VFOE, CLKG_D36, and FDC_EARLY_SEL then each pass an independent
uncapped check, reducing the exact count to 410; those routes are promoted. The
last two hundred sixty-three are
