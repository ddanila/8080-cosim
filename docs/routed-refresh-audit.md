...
WREQ_N, D40QA, MA5, OSC_FB, FDC_RE_N, D40_CTRL_PULL, MA7, and VT2_BASE then each
pass an independent uncapped check, reducing the exact count to 467; those
routes are promoted. The last two hundred six are
