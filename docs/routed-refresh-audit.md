...
factory-registered D95/D97/D102 cluster. The current regenerated source has eight
collision pairs because the corrected factory/photo-proven VD3 and R86 positions expose
the old unregistered L1 and legacy `.006` VT3 seeds as false. S4 is now correctly schematic/off-board
...
1. repair the eight current source-placement electrical overlaps from stronger placement evidence;
