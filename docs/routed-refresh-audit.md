...
X2_IRQ0, IORC_N, and P12V then each pass an independent uncapped check, reducing
the exact count to 57; those routes are promoted. The last six hundred sixteen
are
