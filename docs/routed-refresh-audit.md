...
D105_MEMW_INV, BA1, and SER_DTR then each pass an independent uncapped check,
reducing the exact count to 395; those routes are promoted. The last two hundred
seventy-eight are
