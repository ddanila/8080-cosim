...
D102_C1_C22, and USART_TXRDY_IRQ then each pass an independent uncapped check,
reducing the exact count to 459; those routes are promoted. The last two
hundred fourteen are
