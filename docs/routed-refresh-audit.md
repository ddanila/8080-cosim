...
D103_LD, CAS, and XTAL_TRIM then each pass an independent uncapped check,
reducing the exact count to 505; those routes are promoted. The last one
hundred sixty-eight are
