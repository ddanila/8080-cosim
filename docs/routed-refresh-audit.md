...
AVDC, KBD_K0, and VID_CPU_SEL then each pass an independent uncapped check,
reducing the exact count to 365; those routes are promoted. The last three
hundred eight are selected transactionally by
