...
RAM_OUT_EN, and MA2 then each pass an independent uncapped check, reducing the
exact count to 28; those routes are promoted. The last six hundred forty-five are
