...
VA5, FDC_RCLK, BA5, DB3, PRECOMP_TAP_2, S3_2, D40Q2_D33, and BA2 then each pass
an independent uncapped check, reducing the exact count to 93; those routes are
promoted. The last five hundred eighty are
