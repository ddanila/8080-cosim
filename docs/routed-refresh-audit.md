...
electrical blockers. Eighty-six bounded proposals across P5V, STSTB, GND,
...
D92_NOACC, and D100_CONTROL_SHEET1_BOUNDARY then each pass an independent
uncapped check, reducing the exact count to 591; those routes are promoted.
The last eighty-two are selected transactionally
