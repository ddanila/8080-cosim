...
RAM_OUT_EN, MA2, MA1, S3_5, DB7, MEMR, BA9, BA1, D3_O4_D6_A6, E3_COM, INTR, and RES_RC then
each pass an independent uncapped check, reducing the exact count to 18; those
routes are promoted. The last six hundred fifty-five are
