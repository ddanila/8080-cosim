...
D99_C1_TIMING, RESET, OSC, DBIN, TIMING_TAG17, CLK_123M, and CAS then each pass
an independent uncapped check, reducing the exact count to 370; those routes are
promoted. The last three hundred three are
