...
| Check | Count | Result |
| --- | ---: | --- |
| ERC error violations | 262 | BLOCK |
| PCB/schematic parity issues | 0 | PASS |
| Explicit board-JSON no-connects | 17 | FAIL |
| KiCad schematic no-connect markers | 16 | FAIL |
| Functional pins without net or explicit NC | 262 | BLOCK |
