...
| Check | Count | Result |
| --- | ---: | --- |
| ERC error violations | 254 | BLOCK |
| PCB/schematic parity issues | 0 | PASS |
| Explicit board-JSON no-connects | 22 | PASS |
| KiCad schematic no-connect markers | 22 | PASS |
| Functional pins without net or explicit NC | 254 | BLOCK |
