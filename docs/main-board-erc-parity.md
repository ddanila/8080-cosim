...
| Check | Count | Result |
| --- | ---: | --- |
| ERC error violations | 209 | BLOCK |
| PCB/schematic parity issues | 0 | PASS |
| Explicit board-JSON no-connects | 47 | PASS |
| KiCad schematic no-connect markers | 47 | PASS |
| Functional pins without net or explicit NC | 209 | BLOCK |
