...
| Check | Count | Result |
| --- | ---: | --- |
| ERC error violations | 190 | BLOCK |
| PCB/schematic parity issues | 0 | PASS |
| Explicit board-JSON no-connects | 55 | PASS |
| KiCad schematic no-connect markers | 55 | PASS |
| Functional pins without net or explicit NC | 190 | BLOCK |
