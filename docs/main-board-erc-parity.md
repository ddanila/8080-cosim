...
| Check | Count | Result |
| --- | ---: | --- |
| ERC error violations | 216 | BLOCK |
| PCB/schematic parity issues | 0 | PASS |
| Explicit board-JSON no-connects | 47 | FAIL |
| KiCad schematic no-connect markers | 41 | FAIL |
| Functional pins without net or explicit NC | 216 | BLOCK |
