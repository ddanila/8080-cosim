...
| Check | Count | Result |
| --- | ---: | --- |
| ERC error violations | 225 | BLOCK |
| PCB/schematic parity issues | 0 | PASS |
| Explicit board-JSON no-connects | 41 | FAIL |
| KiCad schematic no-connect markers | 38 | FAIL |
| Functional pins without net or explicit NC | 225 | BLOCK |
