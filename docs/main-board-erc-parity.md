...
| Check | Count | Result |
| --- | ---: | --- |
| ERC error violations | 257 | BLOCK |
| PCB/schematic parity issues | 0 | PASS |
| Explicit board-JSON no-connects | 22 | FAIL |
| KiCad schematic no-connect markers | 19 | FAIL |
| Functional pins without net or explicit NC | 257 | BLOCK |
