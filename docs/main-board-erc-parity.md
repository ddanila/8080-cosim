...
| Check | Count | Result |
| --- | ---: | --- |
| ERC error violations | 178 | BLOCK |
| PCB/schematic parity issues | 0 | PASS |
| Explicit board-JSON no-connects | 61 | PASS |
| KiCad schematic no-connect markers | 61 | PASS |
| Functional pins without net or explicit NC | 178 | BLOCK |
