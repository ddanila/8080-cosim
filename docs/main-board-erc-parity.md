...
| Check | Count | Result |
| --- | ---: | --- |
| ERC error violations | 250 | BLOCK |
| PCB/schematic parity issues | 0 | PASS |
| Explicit board-JSON no-connects | 26 | FAIL |
| KiCad schematic no-connect markers | 22 | FAIL |
| Functional pins without net or explicit NC | 250 | BLOCK |
