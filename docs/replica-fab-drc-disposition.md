...
| `unconnected_items` | 1 | Fix before order |
...
Visual disposition failures: 2

## Failures

- Blocking DRC class `unconnected_items` is nonzero: 1
- Unexpected DRC class without disposition: `track_dangling`=1
