...
| P0 | FDC support signal dispositions | pin-level continuity or an explicit redesign/DNP decision for the still-open D28, D96-D99, D101, and D102 pins. Preserve the source-closed D95 clock mux, complete D106 recovery-counter wiring, D106.7-D28.9-D28.8-D96.3-D96.5-D93.26 chain, and D97/D102/D101 write-precomp chain. D101.1/.3/.5/.6, D97.13, and D102.4 remain the specific precomp-area boundaries; D106 needs no continuity probe, though its waveform still needs bring-up validation | `docs/fdc-hardware-handoff.md`; `ref/schematics/fdc-clock-mux-map.md`; `ref/schematics/fdc-recovery-counter-map.md`; `ref/schematics/fdc-write-precomp-map.md`; `PLAN.md` P0 connectivity gate | completes only the genuinely open support-circuit context without re-probing source-closed timing paths |
