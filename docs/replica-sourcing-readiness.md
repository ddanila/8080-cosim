...
| circuit-review | C_KM | КМ ceramic capacitor | 8 | C9, C10, C11, C12, C15, C16, C19, C34 | modern ceramic capacitor with matching value/voltage/lead spacing |
