...
| circuit-review | C_KM | КМ ceramic capacitor | 12 | C7, C8, C9, C10, C11, C13, C14, C15, C20, C22, C34, C99 | modern ceramic capacitor with matching value/voltage/lead spacing |
