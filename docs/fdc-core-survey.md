...
| Local WD1772 transistor/PLA reference | `ref/wd1772-vg93/wd1772.pdf`, `ref/wd1772-vg93/wd1772pla.txt` | User-provided reverse-engineering material for the WD1772/FD1773/VG93 lineage. The PDF is a searchable KiCad transistor/gate schematic; the text file is a 120-row PLA/PLM table with 19 input and 20 output columns. | Vendored as reference material, not HDL-derived source. | Keep hashes and usage boundary in `docs/wd1772-vg93-reference.md`; use only as a deep signal/state-machine cross-check if a full controller model is required. |
