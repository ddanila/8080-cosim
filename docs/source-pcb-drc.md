...
- Board SHA256: `0df9aef90dbf9790195869969d2eda9304bd71d776e661c17888d0e0cf5d8c43`
- Total violations: `687`
- Unconnected items: `499`
- Short violations: `18`
- Unique colliding pad/item pairs: `9`
...
| --- | ---: |
| `clearance` | 6 |
| `courtyards_overlap` | 120 |
| `hole_to_hole` | 4 |
| `shorting_items` | 18 |
| `silk_over_copper` | 199 |
| `silk_overlap` | 199 |
| `solder_mask_bridge` | 18 |
| `text_thickness` | 123 |
...
| Items shorting two nets (nets GND and C19_1_BOUNDARY) | PTH pad 2 [GND] of R74; PTH pad 1 [C19_1_BOUNDARY] of C19 |
