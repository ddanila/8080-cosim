...
| `CS00000` | Home lab | Stock ROM `#0031`, RomBios 3.43, Janet 1.2 (screen identity; ROMs not dumped). With S21 `00000001`, stock Janet, CPU/RAM/PIT/D11 diagnostics, 19,200-baud V15 reception, CP/M Plus, and sustained NetDisk-v3 passed. The former USART-fault suspicion is rejected. The failed one-command V15 attempt was isolated to the retired host's fixed core-probe window. | Physically confirm the new C host's adaptive stock-assisted V15 path. Separately diagnose intermittent cold starts that produce silence or a continuous low tone. |
