...
| 15 | A7 | `WREQ_N` | traced sheet-1 labels D2 A7/pin15 as -WREQ from edge connector coordinate 107C; chip-removed direct owner continuity 2026-07-14 proves D6 RAM_N output pin11 joins D2.15, superseding the older D6.11-to-D92 interpretation |
