...
| 15 | A7 | `WREQ_N` | traced sheet-1 labels D2 A7/pin15 as -WREQ from edge connector coordinate 107C. Chip-removed direct owner continuity on 2026-07-14 proves D6 RAM_N output pin11 joins D2.15; follow-up direct owner continuity on 2026-07-15 proves the same D6.11 conductor reaches D92.5 and R12.2, with R12.1 at +5V. This restores and physically confirms the older-sheet/held-DSN pull-up branch without restoring the invalid D6.11-D6.12 join |
